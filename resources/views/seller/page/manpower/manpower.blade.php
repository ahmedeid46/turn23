                            ...
                            <td>
                                <div class="action">
                                    ...
                                    @else
                                                ...
                                                <div class="modal fade" id="complete{{ $service->id }}" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('seller.man.power.complete') }}" enctype="multipart/form-data" method="post">
                                                                @csrf
                                        ...
                                        @endforeach
                                    @endif
                                    <button onclick="window.location.href='{{ route('seller.man.power.description',$service->id) }}'" type="button" class="btn btn-primary">Request Description</button>
                                </div>
                                <div class="modal fade" id="accept{{ $service->id }}" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('seller.man.power.accept') }}" enctype="multipart/form-data" method="post">
                                                @csrf
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="datetime-local" class="form-control" name="start_date" id="exampleFormControlTextarea1">
                                                </div>
                                                <div class="modal-body">
                                                    <label for="exampleFormControlTextarea1" class="form-label">Duration(Day)</label>
                                                    <input type="number" min="0" step="1" class="form-control" name="duration" id="exampleFormControlTextarea1">
                                                </div>
                                                <div class="modal-body">
                                                    <label for="exampleFormControlTextarea1" class="form-label">Accommodation Type</label>
                                                    <select class="form-control form-select" name="accommodation">
                                                        <option>Please Select Type Residence</option>
                                                        <option value="1">Full accommodation on the Customer</option>
                                                        <option value="2">Accommodation from the attached price list</option>
                                                        <option value="3">There is no accommodation</option>
                                                    </select>
                                                </div>
                                                <div class="modal-body">
                                                    <label for="exampleFormControlTextarea1" class="form-label">Transportation Type</label>
                                                    <select class="form-control form-select" name="transport">
                                                        <option>Please Select Type Residence</option>
