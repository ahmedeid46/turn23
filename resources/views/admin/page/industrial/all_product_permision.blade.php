                            ...
                            <table class="table">
                                ...
                                @foreach($all_products as $allproduct)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.industrial.permission.all.product.status.inverse',$allproduct->id) }}" class="btn {{  $allproduct->status == 1?"btn-danger":"btn-success" }}">{{  $allproduct->status == 1?"Disable":"Active" }}</a>
                                        </td>
