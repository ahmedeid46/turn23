                                ...
                                @foreach($adminProducts as $adminProduct)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-primary" onclick="window.location.href='{{ route('admin.industrial.show.admin.product',$adminProduct->id) }}'">
    ...
    <div class="modal fade text-start" id="large" tabindex="-1" aria-labelledby="myModalLabel17" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('admin.industrial.create.admin.product') }}" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="modal fade text-start" id="EditForm{{$adminProduct->id}}" tabindex="-1" aria-labelledby="myModalLabel17" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <form method="post" action="{{ route('admin.industrial.update.admin.product') }}" enctype="multipart/form-data">
                        @csrf
