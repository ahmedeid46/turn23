                                        ...
                                        <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                            <div class="invoice-total-wrapper">
                                                ...
                                                <div class="invoice-total-item">
                                                    @if($order->status == 0)
                                                        <form method="post" action="{{ route('admin.industrial.order.submit.admin.product') }}">
                                                            @csrf
                                                            <input type="hidden" name="order_id" value="{{ $order->id }}">
                                                    ...
                                                    @elseif($order->status == 1)
                                                        <form method="post" action="{{ route('admin.industrial.permission.buy.add.price') }}" enctype="multipart/form-data">
                                                            @csrf
                                                            <input type="hidden" name="order_id" value="{{$order->id}}">
