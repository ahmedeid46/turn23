                                    ...
                                    <div class="row invoice-spacing">
                                        <div class="col-xl-8 p-0">
                                            ...
                                            @if ($tender->admin_tender_file == null)
                                                <form method="post" enctype="multipart/form-data" action="{{ route('admin.tender.industrial.accept') }}">
                                                    @csrf
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-1">
                                                    @if ($price->admin_file == null)
                                                        <form method="post" enctype="multipart/form-data" action="{{ route('admin.tender.industrial.price.accept') }}">
                                                            @csrf
