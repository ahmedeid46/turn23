                ...
                <div class="col-md-4 col-xl-4">
                    <div class="card border-0 text-white text-center mb-3">
                        ...
                        <div style="padding-top: 25%" class="card-img-overlay bg-overlay">
                            ...
                            <a href="{{ route('admin.order.chemical.type') }}" class="btn btn-primary">Join</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-xl-4">
                    <div class="card border-0 text-white text-center mb-3">
                        ...
                        <div style="padding-top: 25%" class="card-img-overlay bg-overlay">
                            ...
                            <a href="{{ route('admin.order.industrial.type') }}" class="btn btn-primary">Join</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-xl-4">
                    <div class="card border-0 text-white text-center mb-3">
                        ...
                        <div style="padding-top: 25%" class="card-img-overlay bg-overlay">
                            ...
                            <a href="{{ route('admin.permission.cat.service') }}" class="btn btn-primary">Join</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-xl-4">
                    <div class="card border-0 text-white text-center mb-3">
                        ...
                        <div style="padding-top: 25%" class="card-img-overlay bg-overlay">
                            ...
                            <a href="{{ route('admin.permission.cat.manpower') }}" class="btn btn-primary">Join</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-xl-4">
                    <div class="card border-0 text-white text-center mb-3">
                        ...
                        <div style="padding-top: 25%" class="card-img-overlay bg-overlay">
                            ...
                            <a href="{{ route('admin.equipment.orders') }}" class="btn btn-primary">Join</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-xl-4">
                    <div class="card border-0 text-white text-center mb-3">
                        ...
                        <div style="padding-top: 25%" class="card-img-overlay bg-overlay">
                            ...
                            <a href="{{ route('admin.training.all') }}" class="btn btn-primary">Join</a>
                        </div>
                    </div>
                </div>
            </div>
