                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card border-0 text-white text-center mb-3">
                        ...
                        <div style="padding-top: 65px" class="card-img-overlay bg-overlay">
                            ...
                            @if($cat->id ==1)
                            <a href="{{ route('admin.permission.all.product') }}" class="btn btn-primary">Join</a>
                            @else
                                <a href="{{ route('admin.industrial.permission.all.product') }}" class="btn btn-primary">Join</a>
                            @endif
                        </div>
                    </div>
                </div>
