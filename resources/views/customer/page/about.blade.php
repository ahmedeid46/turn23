...
@section('content')
    <main class="main about">
        <div class="page-header page-header-bg text-left"
             style="background: 50%/cover #D4E1EA url('{{ asset('assets/customer') }}/images/page-header-bg.jpg');">
            <div class="container">
                ...
                <div class="testimonials-carousel owl-carousel owl-theme images-left" data-owl-options="{
                    ...
                    <div class="testimonial">
                        <div class="testimonial-owner">
                            <figure>
                                <img src="{{ asset('assets/customer') }}/images/clients/client1.png" alt="client">
                            </figure>
                    ...
                    <div class="testimonial">
                        <div class="testimonial-owner">
                            <figure>
                                <img src="{{ asset('assets/customer') }}/images/clients/client2.png" alt="client">
                            </figure>
